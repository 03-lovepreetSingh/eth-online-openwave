          ...
          <div className="flex pt-16">
            <div className="container mx-auto px-4 py-8 ">
              <Card className="w-full ">
                ...
                <CardContent className="p-4 h-[calc(100vh-40vh)] overHBAR-hidden">
                  <div className="space-y-4 mb-4 max-h-[60vh] overHBAR-y-auto pr-2">
                    {messages.length === 0 ? (
                            ...
                            <ReactMarkdown
                              ...
                              components={{
                                ...
                                pre: ({ children, ...props }: any) => {
                                  ...
                                  return (
                                    <pre
                                      className="bg-secondary/30 p-3 rounded-md overHBAR-x-auto text-sm font-mono"
                                      {...props}
                                    >
                                      {children}
                                    </pre>
